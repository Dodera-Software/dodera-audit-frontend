...
export function useTutorial() {
    ...
    // ─── Step definitions as computed so t() re-evaluates on locale change ──
    const formTourSteps = computed<DriveStep[]>(() => [
        {
    ...
    const mainTourSteps = computed<DriveStep[]>(() => [
        {
    ...
    async function startTour(): Promise<void> {
        ...
        driver({
            ...
            steps: filterPresentSteps(mainTourSteps.value),
            onDestroyed: () => {
